...
if [[ "$installdep" =~ ^[Yy]$ ]]; then
    ...
    wget -q https://raw.githubusercontent.com/choir94/Allora/refs/heads/main/app.py -O /root/allora-huggingface-walkthrough/app.py
    wget -q https://raw.githubusercontent.com/choir94/Allora/refs/heads/main/requirements.txt -O /root/allora-huggingface-walkthrough/requirements.txt
    wget -q https://github.com/choir94/Allora/blob/main/birn_model_optimized.pth -O /root/allora-huggingface-walkthrough/birn_model_optimized.pth
    wait
